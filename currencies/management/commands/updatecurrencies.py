...
class Command(CurrencyCommand):
    ...
    def get_base(self, option):
        """
        Parse the base commands option. Can be supplied as a 3 character code or a settings variable name
    ...
    def handle(self, *args, **options):
        ...
        if not obj:
            self.log(logging.ERROR,
                     "No currencies found in the db to update; try the currencies commands!")  # -*- coding: utf-8 -*-
